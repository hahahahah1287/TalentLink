...
导出所有可用的 Agent 工具/技能。
"""
from .web_search import web_search, job_search, web_search_skill, job_search_skill, WEB_SEARCH_TOOLS
...
__all__ = [
    ...
    "legal_term_explainer", "statute_checker",
    # 统一接口版本
    "web_search_skill", "job_search_skill",
    "risk_clause_skill", "compliance_skill",
    "legal_term_skill", "statute_skill",
    # 工具列表
    "WEB_SEARCH_TOOLS", "RISK_CLAUSE_TOOLS",
    "COMPLIANCE_CHECK_TOOLS", "LEGAL_TERM_TOOLS",
    "STATUTE_CHECKER_TOOLS", "ALL_TOOLS",
    # 注册表
    "SkillRegistry",
]
